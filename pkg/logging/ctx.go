...
func GetCtxLogger(ctx context.Context, opts ...LoggerOption) (context.Context, zerolog.Logger) {
	if ctx == nil {
	...
	logger := NewLogger(opts...).With().Str(CorrelationIDKey, correlationID.String()).Logger()
